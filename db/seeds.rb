...
new1 = Vehicle.new( make:"Fiat", model:"500", year:"1972", passengers:"4",
                ...
                location:"Florence", price:"150", vehicle_type: "car")
new1.user = will
new1.save
...
new3 = Vehicle.new( make:"Ferrari", model:"Testarossa", year:"1984", passengers:"2",
  ...
  location:"Maranello", price:"270", vehicle_type: "car")
new3.user = will
new3.save
...
new4 = Vehicle.new( make:"Ferrari", model:"F40", year:"1987", passengers:"2",
  ...
  location:"Maranello", price:"196", vehicle_type: "car")
new4.user = will
new4.save
...
new5 = Vehicle.new( make:"Lamborghini", model:"Countach", year:"1974", passengers:"2",
  ...
  location:"Maranello", price:"180", vehicle_type: "car")
new5.user = will
new5.save
...
new6 = Vehicle.new( make:"Lamborghini", model:"Diablo", year:"1998", passengers:"2",
  ...
  location:"Maranello", price:"240", vehicle_type: "car")
new6.user = will
new6.save
...
new7 = Vehicle.new( make:"Volkswagen", model:"Beetle", year:"1964", passengers:"2",
  ...
  location:"Wolfsburg", price:"75", vehicle_type: "car")
new7.user = will
new7.save
...
new8 = Vehicle.new( make:"Volkswagen", model:"Westfalia", year:"1958", passengers:"6",
  ...
  location:"Wolfsburg", price:"85", vehicle_type: "car")
new8.user = will
new8.save
...
new9 = Vehicle.new( make:"Mercedes", model:"sl 300", year:"1951", passengers:"2",
  ...
  location:"Maranello", price:"92", vehicle_type: "car")
new9.user = will
new9.save
...
new10 = Vehicle.new( make:"Mini", model:"Cooper mk II", year:"1968", passengers:"2",
  ...
  location:"Maranello", price:"60", vehicle_type: "car")
new10.user = will
new10.save
